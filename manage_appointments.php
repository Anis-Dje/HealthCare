    ...
    try {
        ...
        if (empty($username) || empty($regPassword)) {
            ...
            if ($existingCount > 0) {
                ...
                header('Location: manage_appointments.php?registered=1');
                exit;
            }
        }
    } catch (Throwable $e) {
...
<body class="admin-body">
    ...
    <script>
        let detailsModal, editModal, deleteModal, registerAdminModal;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            try {
                ...
                registerAdminModal = new bootstrap.Modal(document.getElementById('registerAdminModal'));
